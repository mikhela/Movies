        ...
        <form className="w-[200px] lg:w-[300px]">
            ...
            <label htmlFor="location-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white rounded-lg"></label>
                <div className="relative w-full">
                    <input
                     type="search" id="location-search" className="block p-2.5 w-full z-20 text-xs lg:text-sm rounded-3xl text-white bg-sidebarbg focus:text-white" placeholder="Search for city or address" required 
